 ...
 */
package lightsoutgaming.games.lifeless.onejar.test;
...
public class LifeLessSuite {

    protected static Object test;
    protected static int failures = 0;
    
    public static final String MAIN_CLASS = "lightsoutgaming.games.lifeless.onejar.test.Test";

    public static void main(String args[]) {
        new TestSuite(LifeLessSuite.class).run(new TestResult());
    }
